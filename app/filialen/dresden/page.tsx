...
const galleryImages = [
  {
    ...
    alt: "Kaminofen Studio Dresden"
  },
  {
    src: "/filialen/dresden/filiale_dresden_02.jpg",
    alt: "Große Ausstellungshalle"
  },
  {
    src: "/filialen/dresden/filiale_dresden_03.jpg",
    alt: "Moderne Kamine und Öfen"
  },
  {
    src: "/filialen/dresden/filiale_dresden_04.jpg",
    alt: "Beratungsbereich mit Ambiente"
  },
  {
    src: "/filialen/dresden/filiale_dresden_05.jpg",
    alt: "Hase Kaminofen Studio"
  },
  {
    src: "/filialen/dresden/filiale_dresden_06.jpg",
    alt: "Vielfältige Auswahl"
  }
];
...
export default function DresdenPage() {
  ...
  const features = [
    "Große Auswahl an Kaminöfen & Heizeinsätzen",
    "Exklusives Studio für Gaskamine",
    "Kompetenzzentrum für Wasserführende Technik",
  ...
  return (
    <main className="min-h-screen bg-white font-sans selection:bg-[#E67E22] selection:text-white">
      ...
      <section className="relative h-[60vh] bg-[#1A1A1A] overflow-hidden flex items-center justify-center">
        {/* Background Image - Außenansicht Dresden */}
        <div className="absolute inset-0 z-0">
          <img 
            src="/filialen/dresden/dresden.jpg" 
            alt="Ofenfischer Ausstellung Dresden Außenansicht" 
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
          ...
          >
            <div className="flex items-center justify-center gap-3 mb-6">
              ...
              <span className="text-[#E67E22] font-bold uppercase tracking-[0.3em] text-xs">Sachsen</span>
              <div className="h-[2px] w-12 bg-[#E67E22]"></div>
            </div>
            ...
            <p className="text-xl text-slate-300 font-light max-w-2xl mx-auto leading-relaxed">
              Besuchen Sie unsere exklusive Ausstellung in der Landeshauptstadt. <br/> Traditionelles Handwerk trifft auf modernes Design.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white relative -mt-16 z-20 px-4">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-3 gap-8">
          ...
          >
            ...
            <p className="text-slate-600 mb-1">Großenhainer Str. 197</p>
            <p className="text-slate-600 font-bold mb-6">01129 Dresden</p>
            
            <a 
              href="https://www.google.com/maps/search/?api=1&query=Ofenfischer+Dresden+Großenhainer+Str+197" 
              target="_blank" 
          ...
          >
            ...
            <div className="space-y-3 text-slate-300 w-full text-sm">
              <p className="flex justify-between w-full border-b border-white/10 pb-2">
                <span>Mo, Di, Do, Fr:</span> <span className="text-white font-bold">10:00 - 18:00 Uhr</span>
              </p>
              <p className="flex justify-between w-full border-b border-white/10 pb-2">
                <span>Mittwoch:</span> <span className="text-[#E67E22] font-bold">Geschlossen</span>
              </p>
              <p className="flex justify-between w-full border-b border-white/10 pb-2">
                <span>Samstag:</span> <span className="text-white font-bold">nach Vereinbarung</span>
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <a href="tel:+4935184359602" className="text-lg font-black text-[#1A1A1A] hover:text-[#E67E22] transition-colors mb-1 block">
              +49 (0) 351 / 843 59 602
            </a>
             <a href="tel:+4935184755490" className="text-sm font-medium text-slate-400 hover:text-[#E67E22] transition-colors mb-4 block">
              +49 (0) 351 / 847 55 490
            </a>

            <a href="mailto:dresden@ofenfischer.de" className="text-slate-600 hover:text-[#E67E22] transition-colors flex items-center gap-2 mb-6">
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h2 className="text-4xl md:text-5xl font-black text-[#1A1A1A] uppercase italic tracking-tighter mb-6">
              Feuer erleben in Elbflorenz
            </h2>
            <p className="text-slate-600 text-lg leading-relaxed mb-8">
              In unserer Dresdner Filiale präsentieren wir Ihnen auf großzügiger Fläche die neuesten Trends der Kaminwelt. 
              Vom klassischen Kachelofen bis zum modernen Gaskamin – lassen Sie sich inspirieren. Unsere Fachberater planen gemeinsam mit Ihnen Ihre individuelle Anlage.
            </p>
            ...
            <div className="mt-10 p-6 bg-white rounded-2xl border border-slate-200 flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500 mt-1">
                  Verkehrsgünstig gelegen an der Großenhainer Straße in Dresden-Trachau. 
                  Sie erreichen uns bequem über die A4 (Abfahrt Dresden-Wilder Mann) oder mit öffentlichen Verkehrsmitteln.
                </p>
              </div>
            </div>
          </div>

          {/* Kleiner Teaser - MIT AUSSENBILD & BADGE RECHTS OBEN */}
          <div className="relative h-full min-h-[400px] rounded-3xl overflow-hidden shadow-2xl">
              <img 
                src="/filialen/dresden/dresden.jpg" 
                className="w-full h-full object-cover" 
                alt="Ausstellung Dresden Teaser"
              />
            {/* Badge - Rechts Oben fixiert */}
            <div className="absolute top-6 right-6 bg-[#1A1A1A]/90 backdrop-blur-md text-white p-6 rounded-full shadow-2xl border-4 border-[#E67E22] text-center w-36 h-36 flex flex-col items-center justify-center">
              ...
              <span className="text-[10px] uppercase tracking-widest">Handwerk</span>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-400 mt-4 max-w-2xl mx-auto">
              Erkunden Sie unsere Ausstellung ganz bequem von zu Hause aus.
            </p>
          </div>
